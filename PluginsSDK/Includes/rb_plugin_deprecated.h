...
REAL_DEPRECATED void GraphicsDrawLine(REALgraphics graphicsObject, int x1, int y1, int x2, int y2);
...
REAL_DEPRECATED REALproc REALInterfaceRoutine(REALobject obj, const char *interfaceName, const char *methodName);
...
REAL_DEPRECATED RBInteger REALGraphicsStringWidth(REALgraphics graphics, REALstring str);

REAL_DEPRECATED RBInteger REALGraphicsStringHeight(REALgraphics graphics, REALstring str, RBInteger wrapWidth);

REAL_DEPRECATED RBInteger REALGraphicsTextHeight(REALgraphics graphics);

REAL_DEPRECATED RBInteger REALGraphicsTextAscent(REALgraphics graphics);
