...
uint32_t REALGetSystemTextEncoding()
{
...
bool REALGetPropValueUInt8(REALobject object, const char *name, unsigned char *value)
{
	...
	if (!pGetPropValue)
		pGetPropValue = (RBBoolean (*)(REALobject, const char *, unsigned char *)) CallResolver("REALGetPropValueBool");
	if (pGetPropValue) return (bool)pGetPropValue(object, name, value);
	else return false;
}
#endif
...
RBInteger REALGraphicsStringWidth(REALgraphics graphics, REALstring str)
{
...
RBInteger REALGraphicsStringHeight(REALgraphics graphics, REALstring str, RBInteger wrapWidth)
{
...
RBInteger REALGraphicsTextHeight(REALgraphics graphics)
{
...
RBInteger REALGraphicsTextAscent(REALgraphics graphics)
{
